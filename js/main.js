...
let expensesItems = document.querySelectorAll('.expenses-item'),
    // Button tags 'Утвердить' => expenses-item-btn and 'Утвердить2' => optionalexpenses-btn and 'Расчитать' => count-budget-btn
    ...
    // Optional expenses
let optionalexp = document.querySelectorAll('.optionalexpenses-item');

    // Other
let stats = document.querySelector('.choose-income'),
    checkBoks = document.querySelector('.savings'),
